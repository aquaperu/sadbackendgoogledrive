...
export class ValorizacionController {
    ...
    async createFoldersInWindows(@Req() req:Request){
        const indices = [
            ...
            {esSeparador:1,titulo:'1.1. ASPECTOS GENERALES   ',columna:1},
            {esSeparador:0,titulo:'1.1.1. Resumen Ejecutivo',columna:2},
            {esSeparador:0,titulo:'1.1.2. Ficha Técnica',columna:2},
            {esSeparador:0,titulo:'1.1.3. Memoria Descriptiva',columna:2},
            {esSeparador:0,titulo:'1.1.4. Memoria de Calculo',columna:2},
            {esSeparador:0,titulo:'1.1.5. Planilla de Metrados',columna:2},
            {esSeparador:0,titulo:'1.1.6. Presupuesto de Obra.',columna:2},
            {esSeparador:0,titulo:'1.1.6.1. Cuadro de Resumen de Presupuesto.',columna:3},
            {esSeparador:0,titulo:'1.1.6.2. Presupuesto de obra,',columna:3},
            {esSeparador:0,titulo:'1.1.6.3. Presupuesto Desagregado.',columna:3},   
            {esSeparador:0,titulo:'1.1.6.4. Análisis de costos unitarios.',columna:3},
            {esSeparador:0,titulo:'1.1.6.5. Planilla de metrados',columna:3},
            {esSeparador:0,titulo:'1.1.6.6. Relación de insumos generales y por grupos.',columna:3},
            {esSeparador:0,titulo:'1.1.6.7. Fórmulas Polinómicas.',columna:3},
            {esSeparador:0,titulo:'1.1.6.8. Análisis de Gastos Generales (Fijos y Variables).',columna:3},
            {esSeparador:0,titulo:'1.1.6.9. Gastos de supervisión',columna:3},
            {esSeparador:0,titulo:'1.1.6.10. Gastos en gestión de proyectos',columna:3},
            {esSeparador:0,titulo:'1.1.6.11. Gastos de Control concurrente –CC',columna:3},
            {esSeparador:0,titulo:'1.1.6.12. Gastos de Junta de Resolución de Disputas -JRD ',columna:3},
            {esSeparador:0,titulo:'1.1.6.13. Gastos de Gestión de Riesgos',columna:3},
            {esSeparador:0,titulo:'1.1.6.14. Cotizaciones de materiales y equipos (mínimo de 3).',columna:3},
            {esSeparador:0,titulo:'1.1.6.15. Cálculos de flete, y otros que el área técnica considere necesario para su aprobación.',columna:3},
            {esSeparador:1,titulo:'1.1.7. Análisis de precios Unitarios.',columna:2},
            {esSeparador:1,titulo:'1.1.8. Relación de Insumos.',columna:2},
            {esSeparador:1,titulo:'1.1.9. Cotización de Materiales (mínimo 2 cotizaciones y considerar por el precio menor del insumo).',columna:2},
            {esSeparador:1,titulo:'1.1.10. Fórmula Polinómica',columna:2},
            {esSeparador:1,titulo:'1.1.11. Programación de obra',columna:2},
            {esSeparador:1,titulo:'1.1.11.1. Programación de ejecución de obra',columna:3},
            {esSeparador:1,titulo:'1.1.11.2.  Cronograma de adquisición de materiales',columna:3},
            {esSeparador:1,titulo:'1.1.11.3.  Cronograma de avance de obras valorizado',columna:3},
            {esSeparador:1,titulo:'1.1.12. Especificaciones técnicas.',columna:2},
            {esSeparador:1,titulo:'1.1.13. Planos.',columna:2},
            {esSeparador:0,titulo:'1.1.13.1.  Índice de planos',columna:3},
            {esSeparador:0,titulo:'1.1.13.2. Planos Generales del sistema existente y Planos de sistema proyectado.',columna:3},
            {esSeparador:0,titulo:'1.1.13.3. Plano Clave: Plano de ubicación y localización, con coordenadas UTM y planos de ubicación de canteras y botaderos',columna:3},
            {esSeparador:0,titulo:'1.1.13.4. Plano topográfico.',columna:3},
            {esSeparador:0,titulo:'1.1.13.5. Plano del ámbito de influencia del proyecto, delimitado.',columna:3},
            {esSeparador:0,titulo:'1.1.13.6. Plano Trazado y Lotización Aprobado por el GR/GL correspondiente.',columna:3},
            {esSeparador:0,titulo:'1.1.13.7. Planos de Sistema de Abastecimiento de Agua Potable.',columna:3},
            {esSeparador:0,titulo:'1.1.13.8. Planos del sistema de Tratamiento de Agua Potable PTAP',columna:3},
            {esSeparador:0,titulo:'1.1.13.9. Planos del Almacenamiento de agua para consumo humano',columna:3},
            {esSeparador:0,titulo:'1.1.13.10. Estaciones de bombeo de agua para consumo humano (de ser el caso)',columna:3},
            {esSeparador:0,titulo:'1.1.13.11. Planos de Redes de distribución Agua Potable para consumo humano.',columna:3},
            {esSeparador:0,titulo:'1.1.13.12. Planos de Conexiones Domiciliarias de Agua Potable',columna:3},
            {esSeparador:0,titulo:'1.1.13.13. Plano de drenaje pluvial (de ser el caso)',columna:3},
            {esSeparador:0,titulo:'1.1.13.14. Planos del Sistema de redes de Alcantarillado sanitario',columna:3},
            {esSeparador:0,titulo:'1.1.13.15. Planos de Estación de bombeo de aguas residuales (EBAR) de ser el caso.',columna:3},
            {esSeparador:0,titulo:'1.1.13.16. Planos del sistema de Tratamiento de Aguas Residuales-PTAR',columna:3},
            {esSeparador:0,titulo:'1.1.13.17. Planos de la disposición sanitaria de excretas - UBS.',columna:3},
            {esSeparador:1,titulo:'1.2. ESTUDIOS BÁSICOS',columna:1},
            {esSeparador:1,titulo:'1.2.1. Estudio de Topografía, geodésico y/o de georreferenciación',columna:2},
            {esSeparador:1,titulo:'1.2.2. Estudio de fuentes de agua tales como *Análisis físico-químico y bacteriológico de la fuente y/o fuentes de agua por laboratorio acreditado por INACAL incluido informe de interpretación y panel fotográfico, *Estudios Hidrológicos de aguas superficiales, *Estudios hidrogeológicos para aguas subterráneas para esto si la captación del agua es por pozos tubulares incluye pozo de prueba (nivel estático, nivel dinámico y rendimiento del acuífero), * Resumen de aforos realizados para proyectos en ámbito rural o pequeña ciudad (debe indicar fecha de aforos y responsable del procedimiento),',columna:2},
            {esSeparador:1,titulo:'1.2.3. Estudio de mecánica de Suelos.',columna:2},
            {esSeparador:1,titulo:'1.2.4. Estudio de Gestión de Riesgo en la planificación de ejecución de la obra según la metodología del CENEPRED.',columna:2},
            {esSeparador:1,titulo:'1.3. ANEXOS',columna:1},
            {esSeparador:1,titulo:'1.3.1. Plan de seguridad y salud ocupacional',columna:2},
            {esSeparador:1,titulo:'1.3.2. Manual de operación y mantenimiento',columna:2},
            {esSeparador:1,titulo:'1.3.3. Componente social (plan de capacitaciones)',columna:2},
            {esSeparador:1,titulo:'1.3.4. Panel fotográfico',columna:2},
            {esSeparador:1,titulo:'1.3.5. Saneamiento físico legal, arreglo institucional y/o disponibilidad física del predio o terreno o Predios: Actas de sesión de terrenos, pases, servidumbres u otro documento que muestre la aceptación de los propietarios (Verificar con SUNARP, COFOPRI, SBN, entre otros).',columna:2},
            {esSeparador:1,titulo:'1.3.6. Acreditación hídrica y/o licencia de uso de agua vigente con fines poblacionales emitidas por el ANA o Autoridad Local de Agua (ALA).',columna:2},
            {esSeparador:1,titulo:'1.3.7. Instrumento de gestión ambiental o ficha técnica ambiental).',columna:2},
            {esSeparador:1,titulo:'1.3.8. Certificación de Inexistencia de Restos Arqueológicos (CIRA) o Plan de Monitoreo Arqueológico y Plan de Evaluación Arqueológico (PEA) de corresponder.',columna:2},
            {esSeparador:1,titulo:'1.3.9. EIA o Programa de Adecuación de Manejo Ambiental (PAMA, DIA), Ficha Técnica Ambiental (FTA).',columna:2},
            {esSeparador:1,titulo:'1.3.10. Certificado de Compatibilidad para Proyectos en Áreas Protegidas — SERNANP. si la ubicación del proyecto es Área Natural Protegida o zona de amortiguamiento de corresponder.',columna:2},
            {esSeparador:1,titulo:'1.3.11. Documentos que garanticen la operación y el mantenimiento del PI (JASS o UGM o Empresas Prestadora de Servicios de agua potable) o informe de capacidad de gestión del prestador.',columna:2},
            {esSeparador:1,titulo:'1.3.12. Documento de Factibilidad de Servicio agua potable y alcantarillado (de ser el caso).',columna:2},
            {esSeparador:0,titulo:'1.3.13. Documento de conformidad técnica del proyecto de energía eléctrica o certificado de factibilidad de suministro de energía eléctrica (de ser el caso).',columna:2},
            {esSeparador:1,titulo:'1.3.14. Acta de Compromiso de pago de cuota familiar (Zona Rural).',columna:2},
            {esSeparador:1,titulo:'1.3.15. Padrón General de usuarios actualizados, con su DNI, firma o huella digital correspondiente.',columna:2},
            {esSeparador:1,titulo:'1.3.16. Resolución y/o acta de constitución de Junta Administradora de Servicios de Saneamiento (JASS), zona rural.',columna:2},
            {esSeparador:0,titulo:'1.3.17. Estudio de Canteras y Escombreras.',columna:2},
            {esSeparador:0,titulo:'1.3.18. Autorización Sanitaria de Aprobación de Diseño de las Plantas de Tratamiento de Agua Potable por la DIGESA.',columna:2},
            {esSeparador:0,titulo:'1.3.19. Autorización Sanitaria del Sistema de Tratamiento y Disposición final de Aguas Residuales domésticas con Infiltración en el Terreno — DIGESA',columna:2},
            {esSeparador:0,titulo:'1.3.20. Informe Técnico de la Unidad Ejecutora que demuestre que cuenta con el personal Técnico Administrativo, los equipos necesarios y la Capacidad Operativa para asegurar el cumplimiento de las metas previstas, en caso de Modalidad de Ejecución por Administración Directa',columna:2},
            {esSeparador:0,titulo:'1.3.21. Otros documentos y/o estudios -Información complementaria',columna:2},
            {esSeparador:0,titulo:'1.3.22. Dispositivo portátil UBS de capacidad correspondiente al proyecto versión digital editable (incluye base de datos del presupuesto editable).',columna:2},
            {esSeparador:0,titulo:'1.3.23. Contrato y Términos de referencia de los Adscritos menores a 8 UIT.',columna:2},
